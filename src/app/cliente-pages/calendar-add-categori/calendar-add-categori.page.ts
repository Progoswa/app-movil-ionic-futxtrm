...
@Component({
	selector: 'app-calendar-add-categori',
	templateUrl: './calendar-add-categori.page.html',
	styleUrls: ['./calendar-add-categori.page.scss'],
})
export class CalendarAddCategoriPage implements OnInit {
	categorias: any;
